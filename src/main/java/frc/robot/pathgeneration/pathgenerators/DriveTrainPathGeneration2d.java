...
public class DriveTrainPathGeneration2d extends PathGeneration2d {
  ...
  public DriveTrainPathGeneration2d(WaypointsBase waypoints, WaypointWithHeading initialPoint,
      WaypointWithHeading finalPoint, DriveTrain driveTrain) {
    ...
    m_maxAccelerationMetersPerSecondSquared = m_drivetrainConfig
  ...
  protected RamseteCommand getRamsete(Trajectory trajectory) {
    return new RamseteCommand(trajectory, m_driveTrain::getPose, new RamseteController(m_ramseteB, m_ramseteZeta),
        new SimpleMotorFeedforward(m_sVolts, m_vVoltSecondsPerMeter, m_aVoltSecondsSquaredPerMeter), m_driveKinematics,
