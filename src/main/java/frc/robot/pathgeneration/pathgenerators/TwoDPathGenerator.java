...
public abstract class TwoDPathGenerator extends PathGeneratorBase {
    ...
    public TwoDPathGenerator(String jsonFileName, Config config, boolean resetOdometryToZero) {
        ...
        }, new Waypoint(0,0)); // Inital Waypoint is set to 0,0 because the intial point is taken care of within get generated path.
        trajectory = null;
        try {
    ...
    protected CommandBase getGeneratedPath() {
        RamseteCommand4905 ramseteCommand = new RamseteCommand4905(trajectory,
        () -> getPos(), new RamseteController(m_ramseteB, m_ramseteZeta),
