...
public class ParallelCommandGroup4905 extends Command {
   ...
   * simultaneously. The command composition will finish when the last command
   * finishes. If the composition is interrupted, only the commands that are still
  ...
  public final boolean isFinished() {
    return !m_commands.containsValue(true) || isFinishedAdditional();
  }
