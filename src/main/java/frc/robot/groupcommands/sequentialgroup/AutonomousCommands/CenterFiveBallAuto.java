...
public class CenterFiveBallAuto extends DelayedSequentialCommandGroup {
  ...
  public CenterFiveBallAuto(AutoSubsystemsAndParameters autoSubsystemsAndParameters) {
    ...
    addCommands(new SetGyroAdjustment(180),
        ...
        new ShootWithLimeLight(autoSubsystemsAndParameters.getShooter(), autoSubsystemsAndParameters.getFeeder(),
            autoSubsystemsAndParameters.getLimelight()));
  }
