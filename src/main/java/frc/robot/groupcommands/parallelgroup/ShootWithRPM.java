...
public class ShootWithRPM extends ParallelCommandGroup {
    ...
    /**
     * This takes in a shooter and an rpm and intelligently shoots 
     * all the balls that are currently inside the feeder
     * But you have to manually set both the shooter and series wheel rpm
     * @param shooter
     * @param feeder
     * @param shooterRPM
     * @param seriesRPM
    ...
    public ShootWithRPM(ShooterBase shooter, FeederBase feeder, double shooterRPM, double seriesRPM) {
        ...
        addCommands(
            new ShooterParallelSetShooterVelocity(shooter, seriesRPM, shooterRPM),
     ...
     * @param feeder
     * @param rpm
     * This will we scaled for the series wheel rpm based off the scale factor in the config
     */
    public ShootWithRPM(ShooterBase shooter, FeederBase feeder, double rpm) {
        this(shooter, feeder, rpm,
         rpm * Config4905.getConfig4905().getShooterConfig().getDouble("seriesRPMScale"));
    }
