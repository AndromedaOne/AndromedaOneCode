...
public class TalonSRXController extends WPI_TalonSRX {
  ...
  public double getEncoderPositionTicks() {
    ...
    sensorPosition = (m_subsystemConfig.getBoolean(m_configString + ".encoderInverted") ? -sensorPosition : sensorPosition);
  ...
  public double getEncoderVelocityTicks() {
    ...
    sensorVelocity = (m_subsystemConfig.getBoolean(m_configString + ".encoderInverted") ? -sensorVelocity : sensorVelocity);
