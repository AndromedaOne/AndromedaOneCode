...
public class OnTheFlyEnumTest extends SequentialCommandGroup4905 {
  /**
  ...
  public OnTheFlyEnumTest(SBSDReefPositionEnum reefPos)
    ...
    // this sends the robot to in front of the reef pos
    Pose2d targetPose = reefPos.getReefPosition();
