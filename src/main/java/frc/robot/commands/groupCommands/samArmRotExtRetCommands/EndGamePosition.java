...
public class EndGamePosition extends SequentialCommandGroup4905 {
  /** Creates a new EndGamePosition. */
  public EndGamePosition(SamArmRotateBase armRotate, SamArmExtRetBase armExtRet) {
    addCommands(
  ...
  public void additionalInitialize() {
    ArmRotationExtensionSingleton.getInstance().setAngle(210);
    ArmRotationExtensionSingleton.getInstance().setPosition(0);
