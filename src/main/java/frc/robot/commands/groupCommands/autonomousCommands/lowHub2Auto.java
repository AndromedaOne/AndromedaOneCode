...
import frc.robot.commands.groupCommands.shooterFeederCommands.ShootTarmacLow;
...
public class lowHub2Auto extends SequentialCommandGroup {
  /** Creates a new lowHub2Auto. */
  public lowHub2Auto() {
    ...
    addCommands(
        ...
        new ShootTarmacLow(feeder, topShooterWheel, bottomShooterWheel, shooterAlignment),
