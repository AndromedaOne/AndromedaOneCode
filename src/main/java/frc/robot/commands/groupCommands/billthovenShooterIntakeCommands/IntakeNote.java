...
public class IntakeNote extends SequentialCommandGroup4905 {
  ...
  public IntakeNote(ArmTestBenchRotateBase armRotate, BillEndEffectorPositionBase endEffector,
    ...
    if (endInDrivePosition) {
      addCommands(
          new ParallelDeadlineGroup4905(new RunBillFeeder(feeder, FeederStates.INTAKE),
              new ArmRotateCommand(armRotate, () -> m_armIntakeSetpoint, false, false),
