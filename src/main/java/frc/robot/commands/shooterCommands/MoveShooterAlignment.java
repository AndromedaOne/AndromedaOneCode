...
public class MoveShooterAlignment extends PIDCommand4905 {
  ...
  public MoveShooterAlignment(ShooterAlignmentBase shooterAlignment, DoubleSupplier setpoint,
    ...
    if (tunePID) {
      ...
      getController().setP(m_shooterConfig.getDouble("pValue"));
      getController().setTolerance(m_shooterConfig.getDouble("tolerance"));
      getController().setMinOutputToMove(m_shooterConfig.getDouble("minOutputToMove"));
    }
    getController().setI(m_shooterConfig.getDouble("iValue"));
