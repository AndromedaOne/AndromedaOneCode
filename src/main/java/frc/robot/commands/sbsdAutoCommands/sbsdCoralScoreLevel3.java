...
public class sbsdCoralScoreLevel3 extends SequentialCommandGroup4905 {
  RealCoralIntakeEject m_CoralIntakeEject;

  /** Creates a new sbsdCoralScoreLevel4. */
  public sbsdCoralScoreLevel3() {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new sbsdMoveArmAndEndEffector(() -> SBSDArmSetpoints.ArmSetpoints.LEVEL_3));
  }
