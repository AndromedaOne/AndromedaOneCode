...
/** Add your docs here. */
public class EndEffectorControlCommandInternal extends Command {
  ...
  public EndEffectorControlCommandInternal(boolean useSmartDashboard, boolean doesEnd) {
  ...
  public EndEffectorControlCommandInternal(double setpoint, boolean doesEnd) {
    this(false, doesEnd);
    m_setpoint = setpoint;
  }

  public EndEffectorControlCommandInternal(ArmSetpointsSupplier level, boolean doesEnd) {
    this(false, doesEnd);
    m_level = level;
    m_useLevel = true;
  }
