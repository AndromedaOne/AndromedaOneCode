...
public class TuneBrakeSystem extends CommandBase {
  ...
  public TuneBrakeSystem() {
    ...
    SmartDashboard.putNumber("Brake Speed", 0.0);
  }
  ...
  public void initialize() {
    ...
    SmartDashboard.putNumber("Previous Brake Speed", m_rightServoMotor.get());
    double speed = SmartDashboard.getNumber("Brake Speed", 0.0);
    m_rightServoMotor.set(speed);
    SmartDashboard.putNumber("Current Brake Speed", m_rightServoMotor.get());
  }
