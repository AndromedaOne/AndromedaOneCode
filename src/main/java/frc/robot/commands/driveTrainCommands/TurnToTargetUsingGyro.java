...
public class TurnToTargetUsingGyro extends SequentialCommandGroup4905 {
  ...
  public TurnToTargetUsingGyro(DriveTrainBase driveTrainIntSupplier, IntSupplier wantedID, DoubleSupplier setpoint, 
  boolean useSmartDashboard) {
    //PhotonVisionYawSupplier yawSupplier = new PhotonVisionYawSupplier(wantedID, setpoint);
  }
