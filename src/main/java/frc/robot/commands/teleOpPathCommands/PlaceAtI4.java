...
public class PlaceAtI4 extends SequentialCommandGroup4905 {
  /**
  ...
  public PlaceAtI4() throws FileVersionException, IOException, ParseException {
    m_driveTrainBase = Robot.getInstance().getSubsystemsContainer().getDriveTrain();
    Pose2d targetPose = new Pose2d(5.740, 6.294, Rotation2d.fromDegrees(60));
