...
public class PlaceAtF4 extends SequentialCommandGroup4905 {
  /**
  ...
  public PlaceAtF4() throws FileVersionException, IOException, ParseException {
    m_driveTrainBase = Robot.getInstance().getSubsystemsContainer().getDriveTrain();
    Pose2d targetPose = new Pose2d(5.546, 2.655, Rotation2d.fromDegrees(300));
