...
public class StraightLineHalfMeter extends SequentialCommandGroup4905 {
  /** Creates a new StraightLineHalfMeter. */

  DriveTrainBase m_driveTrainBase;

  public StraightLineHalfMeter() throws FileVersionException, IOException, ParseException {
