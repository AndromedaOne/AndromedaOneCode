...
public class PlaceAtG4 extends SequentialCommandGroup4905 {
  /**
  ...
  public PlaceAtG4() throws FileVersionException, IOException, ParseException {
    m_driveTrainBase = Robot.getInstance().getSubsystemsContainer().getDriveTrain();
    Pose2d targetPose = new Pose2d(6.202, 4.222, Rotation2d.fromDegrees(0));
