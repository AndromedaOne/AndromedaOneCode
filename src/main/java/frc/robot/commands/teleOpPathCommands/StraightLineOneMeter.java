...
public class StraightLineOneMeter extends SequentialCommandGroup4905 {
  /** Creates a new StraightLineHalfMeter. */

  DriveTrainBase m_driveTrainBase;

  public StraightLineOneMeter() throws FileVersionException, IOException, ParseException {
    m_driveTrainBase = Robot.getInstance().getSubsystemsContainer().getDriveTrain();
    addRequirements(m_driveTrainBase.getSubsystemBase());
    PathPlannerPath path = PathPlannerPath.fromPathFile("Straight Line 1");
