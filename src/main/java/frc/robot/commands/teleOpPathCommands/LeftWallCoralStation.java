...
public class LeftWallCoralStation extends SequentialCommandGroup4905 {
  /**
  ...
  public LeftWallCoralStation() throws FileVersionException, IOException, ParseException {
    m_driveTrainBase = Robot.getInstance().getSubsystemsContainer().getDriveTrain();
    addRequirements(m_driveTrainBase.getSubsystemBase());
    PathPlannerPath path = PathPlannerPath.fromPathFile("LeftWallCoralStation");
