...
public class PlaceAtD4 extends SequentialCommandGroup4905 {
  /**
  ...
  public PlaceAtD4() throws FileVersionException, IOException, ParseException {
    m_driveTrainBase = Robot.getInstance().getSubsystemsContainer().getDriveTrain();
    Pose2d targetPose = new Pose2d(3.811, 2.437, Rotation2d.fromDegrees(60));
